...
public class ProsteDaty {
	...
	public static void main(String[] args) {
		...
		LocalDate data4 = LocalDate.parse("2010-12-05");
		System.out.println(data4);

		LocalDate data5 = LocalDate.parse("2016-02-29");
		System.out.println(data5);

//		LocalDate data6 = LocalDate.parse("2017-02-29");
//		System.out.println(data6);
		...
		System.out.println(czasTrwania.getDays());  // odczyt pola "days" , a nie przeliczenie na dni
